...
/**
 * The featured story rendered as the home-page hero — same data as {@link SyntheticStoryCard} but
 * rendered by the full-bleed {@code story-hero} card layout.
 */
public class SyntheticHeroStoryCard extends SyntheticStoryCard {

  public SyntheticHeroStoryCard(@Nonnull final String title, @Nonnull final String excerpt,
