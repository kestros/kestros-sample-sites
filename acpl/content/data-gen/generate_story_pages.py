...
DATA = os.path.join(BASE, "..", "core", "src", "main", "resources", "data")
...
def story_page(s):
    ...
    main = (
        ...
        f'<col layout="plain" variations="[col-lg-8,mx-auto]" jcr:primaryType="nt:unstructured" sling:resourceType="/libs/kestros/commons/components/structure/container">'
        ...
        f'{paras}'
        f'<back href="{SITE}/stories.html" variations="[btn,btn-outline-primary,btn-sm,mt-3]" jcr:primaryType="nt:unstructured" sling:resourceType="/libs/kestros/commons/components/content/link" text="← Back to all stories"/>{matchbtn}'
        f'</col></row></wrap>'
